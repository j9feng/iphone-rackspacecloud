...
static NSString *_activeResourceAuthToken = nil;
...
+ (NSString *)getRemoteAuthToken {
	return _activeResourceAuthToken;
}
+ (void)setRemoteAuthToken:(NSString *)authToken {
	if (_activeResourceAuthToken != authToken) {
		[_activeResourceAuthToken autorelease];
		_activeResourceAuthToken = [authToken copy];
	}
}
